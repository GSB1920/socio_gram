const VARIANT_CLASSES = {
  feed: "w-full aspect-[4/5] max-h-[min(65dvh,520px)] overflow-hidden rounded-sm border border-zinc-100 bg-zinc-100 dark:border-zinc-800 dark:bg-zinc-900 md:max-h-[min(68dvh,560px)] lg:max-h-[min(70dvh,580px)]",
